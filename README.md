...
- [[ Lucky-Admin-Vue3 ]](https://gitee.com/xiaodu6/lucky-admin-vue3)：一个基于vue-admin-template的后台管理框架，集成了动态角色权限，动态路由，角色权限动态配置，日志框架，代码生成，Sa-Token权限校验，快速构建一个后台的开发框架。
...
- [[ Lambda Fusion Framework ]](https://gitee.com/westboy/lambda-fusion-parent)：基于 Spring Boot 4.0 + JDK 21 构建的全栈企业级微服务开发框架。提供开箱即用的权限管理、配置管理、数据字典、AI 智能平台等核心业务功能，助力快速构建微服务应用。
...
- [[ Petrichor ]](https://github.com/Ciao1019/Petrichor)：开源、自托管的知识平台，用 Markdown 写作，将内容编译成语义 Wiki，通过 Agentic RAG 生成可追溯的回答，权限认证引用 [sa-token-go](https://github.com/sa-tokens/sa-token-go)。
